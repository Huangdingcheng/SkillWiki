...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    from ..storage.postgres_db import PostgresConnection, ExecutionHistoryRepository
    ...
    # Close optional PostgreSQL connection.
    if app_state.pg_conn:
        await app_state.pg_conn.disconnect()
