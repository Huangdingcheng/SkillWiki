...
from skillos.config import get_config_manager
...
from skillos.utils.logger import get_logger
...
def main(
    ...
    """初始化 SkillOS 数据库（PostgreSQL + Neo4j + Redis）。"""
