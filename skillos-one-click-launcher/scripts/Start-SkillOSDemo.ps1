...
function Ensure-DeepSeekConfig {
    ...
    Write-Host ""
    Write-Host "DeepSeek API configuration is required for this SkillOS demo."
    ...
    $configLines = @(
        "# Local SkillOS demo configuration.",
        "# This file is generated by Start-SkillOSDemo.ps1 and ignored by Git.",
        "# Do not commit or share this file.",
        "",
        "# Optional: set a Python executable with SkillOS backend dependencies.",
    ...
    Write-Host ""
    Write-Host "DeepSeek config saved. Starting SkillOS..."
    Write-Host ""
}
